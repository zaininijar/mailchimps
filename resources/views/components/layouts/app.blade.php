<!DOCTYPE html>
<!-- saved from url=(0042)https://mailchimp.com/switch-to-mailchimp/ -->
<html lang="en" class="js-focus-visible js" data-js-focus-visible="" data-menu-position="top">
...
<head>
    ...
    <title>
        Switch to Mailchimp - Get Powerful Marketing Tools | Mailchimp
    </title>

    <link rel="stylesheet" href="{{ asset('assets') }}/css/critical.css" />
    <link rel="stylesheet" href="{{ asset('assets') }}/css/common.css" />
    <link rel="stylesheet" href="{{ asset('assets') }}/css/below-fold.css" />
    ...
    <script type="text/javascript">
    window.optimizelyLoadedSync = false;
    </script>
    ...
    <script type="text/javascript" src="{{ asset('assets') }}/index.86d056da.1.js" defer=""></script>

    <script type="application/javascript" src="{{ asset('assets') }}/embed2.js" defer="" id="__ada" data-lazy=""
        data-handle="mailchimp" data-behavior="Ada"></script>
    ...
    !(function() {
        ...
        try {
            var n = decodeURIComponent(
                "%7B%0A%0A%20%20%20%20%20%22ResourceTiming%22%3A%7B%0A%0A%20%20%20%20%20%20%20%20%20%20%20%22comment%22%3A%20%22Clear%20RT%20Buffer%20on%20mPulse%20beacon%22%2C%0A%0A%20%20%20%20%20%20%20%20%20%20%20%22clearOnBeacon%22%3A%20true%0A%0A%20%20%20%20%20%7D%2C%0A%0A%20%20%20%20%20%22AutoXHR%22%3A%7B%0A%0A%20%20%20%20%20%20%20%20%20%20%20%22comment%22%3A%20%22Monitor%20XHRs%20requested%20using%20FETCH%22%2C%0A%0A%20%20%20%20%20%20%20%20%20%20%20%22monitorFetch%22%3A%20true%2C%0A%0A%20%20%20%20%20%20%20%20%20%20%20%22comment%22%3A%20%22Start%20Monitoring%20SPAs%20from%20Click%22%2C%0A%0A%20%20%20%20%20%20%20%20%20%20%20%22spaStartFromClick%22%3A%20true%0A%0A%20%20%20%20%20%7D%2C%0A%0A%20%20%20%20%20%22PageParams%22%3A%7B%0A%0A%20%20%20%20%20%20%20%20%20%20%20%22comment%22%3A%20%22Monitor%20all%20SPA%20XHRs%22%2C%0A%0A%20%20%20%20%20%20%20%20%20%20%20%22spaXhr%22%3A%20%22all%22%0A%0A%20%20%20%20%20%7D%0A%0A%7D"
            );
            if (
                n.length > 0 &&
                window.JSON &&
    ...
    !(function(e) {
        ...
        if (
            ((window.BOOMR_API_key = "QAT5G-9HZLF-7EDMX-YMVCJ-QZJDA"),
                (function() {
                    ...
                    if (
                        ...
                        (window.BOOMR.url = n + "QAT5G-9HZLF-7EDMX-YMVCJ-QZJDA");
                        var i =
            ...
            if (
                ...
                e.performance.setResourceTimingBufferSize(400);
        !(function() {
            if (
                ((BOOMR = e.BOOMR || {}),
                ...
                var n = "" == "true" ? 1 : 0,
                    t = "",
                    a = "ercqtlixe7xxezn7rnha-f-786f5d599-clientnsv4-s.akamaihd.net",
                    i = "false" == "true" ? 2 : 1,
                    o = {
                        "ak.v": "36",
                        "ak.cp": "641050",
                        "ak.ai": parseInt("246331", 10),
                        "ak.ol": "0",
                        "ak.cr": 25,
                        "ak.ipv": 4,
                        "ak.proto": "h2",
                        ...
                        "ak.acc": "",
                        "ak.t": "1707051854",
                        "ak.ak": "hOBiQwZUYzCg5VSAfCLimQ==",
                        "ak.pv": "465",
                        "ak.dpoabenc": "",
                        "ak.tf": i,
                    };
    ...
    <link href="https://s2.go-mpulse.net/boomerang/QAT5G-9HZLF-7EDMX-YMVCJ-QZJDA" rel="preload" as="script" />
    <iframe src="{{ asset('assets') }}/saved_resource.html" title="" role="presentation" loading="eager"
        style="width: 0px; height: 0px; border: 0px; display: none"></iframe>
    <script charset="utf-8" src="{{ asset('assets') }}/53.9800d379b5db1912f17b.1.js"></script>
    <script charset="utf-8" src="{{ asset('assets') }}/49.4d7dd4ce39375a821f85.1.js"></script>
    <script charset="utf-8" src="{{ asset('assets') }}/104.8ea5edc6a6b798d97b33.1.js"></script>
    <script charset="utf-8" src="{{ asset('assets') }}/127.3bac521885c523e6e1c4.1.js"></script>
    <script charset="utf-8" src="{{ asset('assets') }}/64.8c777866ca9b2f6edd9a.1.js"></script>
    <script charset="utf-8" src="{{ asset('assets') }}/100.aa36c0692c83de2d5d12.1.js"></script>
    <script charset="utf-8" src="{{ asset('assets') }}/111.a1afe6128d614bf79875.1.js"></script>
    <script charset="utf-8" src="{{ asset('assets') }}/73.410072bf132cea40ded5.1.js"></script>
    <script charset="utf-8" src="{{ asset('assets') }}/72.86e2d2295acce1dd9e2e.1.js"></script>
    <style type="text/css">
            ...
            xmlhttp.onreadystatechange = function() {
                if (xmlhttp.readyState == XMLHttpRequest.DONE) {
                    if (xmlhttp.status == 200) {
                        ...
                        console.log(XMLHttpRequestlhttp.status);
                    }
                }
            };

            var searchString =
                "https://api.cdnjs.com/libraries?search=" + library;
    ...
    <script type="text/javascript" async="" src="{{ asset('assets') }}/embed2.369dae9.js"></script>
    <script src="{{ asset('assets') }}/otBannerSdk.js" async="" type="text/javascript"></script>

    <script src="{{ asset('assets') }}/8896740779.js" type="text/javascript" class="optanon-category-3"></script>
    ...
    (function() {
        ...
        try {
            new g(
                100,
                "r",
                "QSI_S_ZN_cYLzuCZeQ15WxVP",
                "https://zncylzuczeq15wxvp-mailchimp.siteintercept.qualtrics.com/SIE/?Q_ZID=ZN_cYLzuCZeQ15WxVP"
            ).start();
        } catch (i) {}
    })();
